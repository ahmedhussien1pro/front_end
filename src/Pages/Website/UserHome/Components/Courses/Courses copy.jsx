  ...
  return (
    <div className='course-page py-5'>
      <div className='container'>
        <div className='category-menu-row mb-5'>
          <div className='category-menu-container shadow-sm rounded p-3'>
            <ul className='category-list d-flex justify-content-center flex-wrap gap-3'>
              {categories.map((cat) => (
        ...
        <div className='row g-4 justify-content-center'>
          {displayedCourses.map((course, index) => {
            ...
            const CardContent = (
              <div className='card course-card shadow-sm  rounded-4 overflow-hidden h-100'>
                {/* Image */}
                <div className='position-relative course-card__image-wrapper'>
                  ...
                  {/* Hover Overlay */}
                  <div className='card-hover-overlay position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center justify-content-center gap-3 bg-dark bg-opacity-50 opacity-0 transition-opacity duration-300'>
                    <Button
                      className='icon-button favorite-button rounded-circle shadow-none'
                      onClick={(e) => {
                        e.preventDefault();
                        e.stopPropagation();
                    ...
                    <Button
                      variant='light'
                      className='icon-button info-button rounded-circle shadow-sm'
                      onClick={(e) => handleInfoClick(course, e)}>
                      <i className='fas fa-info secondary-text fs-5' />
                    </Button>
                  </div>
                </div>
          ...
          <MUIPagination
            ...
            sx={{
              ...
              '& .Mui-selected': {
                ...
                color: 'var(--whiteColor)',
                '&:hover': {
                  backgroundColor: 'var(--main-color4)',
                },
              },
